            ...
            failure?(
              <h1>
                ...
                <div>
                    <h1>
                     {
                        data?.name?`username is ${data.name}`:"the response is 404 not found"
                     }
                    </h1>
                    <img src={data?.avatar_url || url} alt={`${data?.name || "404"} Avatar github image`} />
                </div>
            )
           }
        </>
